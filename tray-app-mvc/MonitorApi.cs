...
namespace tray_app_mvc
{
    internal class MonitorApi
    {
        ...
        {
            [DataMember(Order = 0)] public string Description { get; private set; }

            [DataMember(Order = 1)] public int MonitorIndex { get; private set; }

            public SafePhysicalMonitorHandle Handle { get; }

            public bool IsSupported => IsHighLevelSupported;

            [DataMember(Order = 2)] public bool IsHighLevelSupported { get; private set; }
        ...
        /// </remarks>
        public static (bool success, uint minimum, uint current, uint maximum) GetBrightness(
